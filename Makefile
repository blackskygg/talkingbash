...
topdir = .
BUILD_DIR = /home/sky/Downloads/bash-4.3
top_builddir = /home/sky/Downloads/bash-4.3
srcdir = .
VPATH = .
...
LOCAL_LIBS = 
LIBS = $(BUILTINS_LIB) $(LIBRARIES) -ldl -lSDL2
LIBS_FOR_BUILD = 
...
CSOURCES = shell.c eval.c parse.y general.c make_cmd.c print_cmd.c y.tab.c \
	   ...
	   pcomplete.c pcomplib.c syntax.c xmalloc.c playsound.c
